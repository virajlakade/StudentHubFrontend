...
export default function RoommateCard({
    ...
    const isOwnPost = useMemo(() => {
        return Number(post.user?.id) === Number(currentUserId);
    }, [post, currentUserId]);
    ...
    const existingRequest = useMemo(() => {
        return requests.find(
            (req) =>
                req.post?.id === post.id &&
                Number(req.sender?.id) === Number(currentUserId)
        );
    }, [requests, post, currentUserId]);
            ...
            <div className="rm-card-header">
                ...
                <div className="creator-profile-info">
                    ...
                    <div className="creator-details">
                        <h3 className="creator-name">{post.contactName}</h3>

                        <span className="creator-subtext">
              {post.degreeProgram || "Student"}
                            {post.yearOfStudy && ` • Year ${post.yearOfStudy}`}
            </span>
                    </div>
            ...
            {showConnectForm && (
                ...
                >
                    ...
                    <div className="form-title">
                        Send connection request to {post.contactName}
                    </div>
